...
echo "📥 可选后续操作："
echo "  - tailscale-docker.sh：WSL 内网代理"
echo "  - install-ollama.sh / install-openwebui.sh / install-anythingllm-server.sh：一键安装本地 AI 工具链"
echo "  - curl --socks5 localhost:1077 https://ifconfig.me 测试代理连接"
echo "📂 所有脚本请置于 ~/wsl-ai-launcher/modules 目录统一管理。"
